...
void saveWithMmap(const string &file_name) {
    ...
    long file_size = 0;
    char sumStr[16];
    int start = toCharArray(circle_sum, sumStr);
    sumStr[start] = '\n';
    file_size += (++start + resByteNum[0] + resByteNum[1] + resByteNum[2] + resByteNum[3] + resByteNum[4]);
