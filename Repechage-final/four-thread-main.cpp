...
int resByteNum1[5];
int resNum1[5];
char *res1[5] = {res13, res14, res15, res16, res17};
...
int resByteNum2[5];
int resNum2[5];
char *res2[5] = {res23, res24, res25, res26, res27};
...
int resByteNum3[5];
int resNum3[5];
char *res3[5] = {res33, res34, res35, res36, res37};
...
int resByteNum4[5];
int resNum4[5];
char *res4[5] = {res43, res44, res45, res46, res47};
...
void work() {
    ...
    int (*circleByteNum1)[5] = new int[node_sum][5];
    fill(circleByteNum1[0], circleByteNum1[0] + node_sum * 5, 0);
    threadRes[0].circleByteNum = circleByteNum1;
    threadRes[0].resByteNum = resByteNum1;
    threadRes[0].resNum = resNum1;

    threadRes[1].res = res2;
    int (*circleByteNum2)[5] = new int[node_sum][5];
    fill(circleByteNum2[0], circleByteNum2[0] + node_sum * 5, 0);
    threadRes[1].circleByteNum = circleByteNum2;
    threadRes[1].resByteNum = resByteNum2;
    threadRes[1].resNum = resNum2;

    threadRes[2].res = res3;
    int (*circleByteNum3)[5] = new int[node_sum][5];
    fill(circleByteNum3[0], circleByteNum3[0] + node_sum * 5, 0);
    threadRes[2].circleByteNum = circleByteNum3;
    threadRes[2].resByteNum = resByteNum3;
    threadRes[2].resNum = resNum3;

    threadRes[3].res = res4;
    int (*circleByteNum4)[5] = new int[node_sum][5];
    fill(circleByteNum4[0], circleByteNum4[0] + node_sum * 5, 0);
    ...
    for (int i = 0; i < 5; ++i) {
        ...
        for (int j = 0; j < node_sum; ++j) {
            int resByte = threadRes[j % 4].circleByteNum[j][i];
            memcpy(ans[i] + loc1, threadRes[j % 4].res[i] + loc2[j % 4], resByte);
            loc1 += resByte;
            loc2[j % 4] += resByte;
        }
        ansByteNum[i] = loc1;
